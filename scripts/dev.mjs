...
async function ensureDevSpaShell() {
  ...
  try {
    ...
    console.log(`[global_dev] Marked ${publicDir} as a development stub directory`);
  }
  console.log('[global_dev] Note: packaged servers automatically ignore this stub directory');
}
